...
import {TestAction, TestColumns} from "@/pages/tests/components";
...
const TestList = () => {
    const {items:tests, fetchData: fetchTests, loading, setLoading, error, setError, pagination, handlePageChange, handleRowsPerPageChange, handleSearchTermChange, searchTerm, handleSearchChange, searchCriteria} =
