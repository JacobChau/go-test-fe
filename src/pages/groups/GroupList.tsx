...
const GroupList = () => {
    const {items:groups, fetchData: fetchGroups, loading, setLoading, error, setError, pagination, handlePageChange, handleRowsPerPageChange, handleSearchTermChange, searchTerm, handleSearchChange, searchCriteria} =
    ...
    const handleGroupUpdated = async (_id: string, updatedGroup: GroupAttributes) => {
        setLoading(true);
        try {
