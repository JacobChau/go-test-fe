...
const MultipleChoiceOptions: FC<MultipleChoiceOptionsProps> = ({ isMultipleAnswer, options, handleOptionChange, useQuillEditor, toggleEditor }) => {
                        ...
                        <Grid item sx={{ width: "fit-content" }}>
                            {isMultipleAnswer ? (
                                ...
                                <RadioGroup
                                    ...
                                    onChange={(event) => handleOptionChange(index, "isCorrect", event.target.value)}
                                >
                                    <FormControlLabel
                                        sx={{ ml: 0, mr: 3, border: `1px solid ${theme.palette.divider}`, borderRadius: "4px" }}
                                        label={<Typography
                        ...
                        <Grid item xs>
                            {useQuillEditor ? (
                                <QuillEditor
                                    key={option.id}
                                    value={option.text}
                                    onChange={(value: any) => handleOptionChange(index, "text", value)}
                                    minHeight={8}
                                />
                            ) : (
                                <TextField
